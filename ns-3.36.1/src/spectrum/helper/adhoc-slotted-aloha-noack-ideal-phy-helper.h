...
public:
  ...
  /**
   * @param type the type of queue to set. eg "ns3::DropTailQueue<Packet>"
   * @param size the max size of the queue want to set
   */
  void SetQueueSize (std::string type, uint32_t size);
