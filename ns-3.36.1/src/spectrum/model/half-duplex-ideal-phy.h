...
public:
  struct UncancelledPacketStats
  {
    uint32_t uncancelledCount;
    uint32_t totalReceivedCount;
    uint32_t totalReceivedDist1;
   ...
   */
  void SetSlotDuration (Time slot);

  /**
   * Get the slot duration for this PHY
   *
  ...
  /**
   * To calculate the number of packets remaining at last that are uncancelled.
   */
...
private:
  ...
  //!< Map to store the slot: packets arrived
  // So that if multiple packets arrive in the slot we can store them 
  ...
  */
  ...
  //Uncancelled packets remaining in the end.
  std::set<std::pair<Mac48Address, Time>> m_phyUniqueReceptions;
  std::set<std::pair<Mac48Address, Time>> m_phyUniqueReceptionsDist1;
  std::set<std::pair<Mac48Address, Time>> m_phyUniqueReceptionsDist2;
  std::set<std::pair<Mac48Address, Time>> notReceivedDueToCurrentTransmission;
